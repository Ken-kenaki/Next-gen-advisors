...
import { ChevronDown, BookOpen, Clock, Briefcase, DollarSign, FileText, Calendar } from "lucide-react";
    ...
    const studyRequirements = [
        {
            ...
            description: "You must have an acceptance letter from a Designated Learning Institution (DLI) in Canada."
        },
        {
            icon: DollarSign,
            title: "Proof of Funds",
            description: "Demonstrate you can cover tuition fees (CAD 10,000+ per year) and living expenses (CAD 11,000+ per year)."
        },
        {
            icon: BookOpen,
            title: "Language Proficiency",
            description: "Provide IELTS (6.0+), TOEFL (80+), or other approved English/French test results."
        },
        {
            icon: Briefcase,
            title: "Study Permit",
            description: "Apply for a Canadian Study Permit after receiving your Letter of Acceptance."
        }
    ];
    ...
    const faqs = [
        {
            ...
            answer: "Tuition fees depend on the program and institution: Undergraduate: CAD 15,000 – CAD 30,000 per year, Postgraduate: CAD 18,000 – CAD 35,000 per year. Living expenses usually range from CAD 10,000 – CAD 15,000 per year, depending on the city and lifestyle."
        },
        {
            question: "Can I work while studying in Canada?",
            answer: "Yes! International students can work up to 20 hours per week during academic sessions and full-time during scheduled breaks—no additional work permit required. This helps with expenses and gaining Canadian work experience."
        },
        {
            question: "Are scholarships available for international students in Canada?",
            answer: "Yes. Canadian universities offer merit-based, need-based, and entrance scholarships. Some government and external scholarships for Nepali students include: Vanier Canada Graduate Scholarships, Lester B. Pearson International Scholarship, and university-specific scholarships."
        },
        {
            question: "What are the main intakes in Canadian universities?",
            answer: "There are three main intakes: Fall Intake: September (most popular), Winter Intake: January, Spring/Summer Intake: May (limited programs). Apply 6–9 months in advance to secure your spot and meet visa processing timelines."
        },
        {
            question: "What do I need to apply for a Canadian student visa (Study Permit)?",
            answer: "Letter of Acceptance (LOA) from a Designated Learning Institution (DLI), Proof of funds, Valid passport, English/French proficiency (IELTS, TOEFL, etc.), Immigration Medical Exam (IME) and police clearance (if applicable), Completed Study Permit application and biometrics."
        }
    ];
        ...
        <div className="bg-white pt-25">
            ...
            <div className="relative bg-gray-900">
                <div className="absolute inset-0 overflow-hidden">
                    <Image
                        src="https://images.unsplash.com/photo-1573497491765-dccce02b29df?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            >
                                World-class education with multicultural experiences. Canada offers affordable tuition and excellent post-study work opportunities.
                            </motion.p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Experience <span className="text-[#35B354]">Canadian Education</span></h2>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">Discover why Canada is a top choice for international students</p>
                </div>

                <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden shadow-xl">
                    <iframe
                        className="w-full h-[500px]"
                        src="https://www.youtube.com/embed/7CKmamDlQ6M"
                        title="Canadian University Experience"
            ...
            <div id="universities" className="bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Top <span className="text-[#35B354]">Universities</span> in Canada</h2>
            ...
            <div id="requirements" className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Canada Study <span className="text-[#35B354]">Requirements</span></h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">Essential criteria for Nepali students planning to study in Canada</p>
                    </div>
            ...
            <div id="intakes" className="bg-[#35B354]/5 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Canadian University <span className="text-[#35B354]">Intakes</span></h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
                            ...
                            {intakes.map((intake, index) => (
                                ...
                                >
                                    ...
                                    <div className={`p-4 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>{intake.note}</div>
                                </motion.div>
                            ))}
                        </div>
                    </div>
            ...
            <div className="bg-[#35B354] py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-white mb-6">Ready to Begin Your Canadian Education Journey?</h2>
