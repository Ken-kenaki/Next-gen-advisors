  ...
  const studyRequirements = [
    {
      ...
      description:
        "You must have an offer of admission from a recognized Australian educational institution and meet academic and English language standards.",
    },
    {
      icon: DollarSign,
      title: "Proof of Funds",
      description:
        "Show evidence that you can cover tuition fees, living costs, and health insurance during your stay.",
    },
    {
      icon: BookOpen,
      title: "English Proficiency",
      description:
        "Take an accepted English test like IELTS, TOEFL, or PTE to meet the language requirement.",
    },
    {
      icon: Briefcase,
      title: "GTE Statement",
      description:
        "Provide a Genuine Temporary Entrant (GTE) statement showing your intent to study temporarily and return home after your course.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Tuition fees vary by course and university: Undergraduate: AUD 20,000 – AUD 45,000 per year, Postgraduate: AUD 22,000 – AUD 50,000 per year. Living expenses are around AUD 1,500 – AUD 2,500 per month, depending on the city.",
    },
    {
      question: "Can international students work while studying in Australia?",
      answer:
        "Yes! Student visa holders can work up to 48 hours per fortnight during study periods and full-time during scheduled holidays. This helps with living costs and gaining work experience.",
    },
    {
      question: "Are scholarships available for Nepali students in Australia?",
      answer:
        "Absolutely. Many universities offer merit-based scholarships, and the Australian Government provides options like: Australia Awards, Destination Australia Scholarships, and university-specific financial aid.",
    },
    {
      question: "What are the main intakes in Australian universities?",
      answer:
        "There are two main intakes: Semester 1: February – June (apply by Aug–Nov), Semester 2: July – Nov (apply by Dec–Apr). Some institutions also offer a Summer Intake in December.",
    },
    {
      question: "What documents are required for an Australian student visa?",
      answer:
        "Confirmation of Enrollment (CoE), Valid passport, Proof of funds, English language test results (IELTS, TOEFL, etc.), Genuine Temporary Entrant (GTE) statement, OSHC (health insurance), Visa application and biometrics.",
    },
  ];
    ...
    <div className="bg-white pt-25">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              >
                World-class education with stunning landscapes. Australia offers
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">
            Experience{" "}
            <span className="text-[#35B354]">Australian Education</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Discover what makes Australian universities among the best in the
            world
          </p>
        </div>
      ...
      <div id="universities" className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Top <span className="text-[#35B354]">Universities</span> in
              Australia
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <div id="requirements" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Essential criteria for Nepali students planning to study in
              Australia
            </p>
          </div>
