    ...
    const studyRequirements = [
        {
            ...
            description: "Gain admission to a SEVP-certified U.S. college/university to receive Form I-20 for visa process."
        },
        {
            icon: BookOpen,
            title: "Academic Requirements",
            description: "Submit transcripts and standardized test scores (SAT/ACT for undergrad, GRE/GMAT for grad)."
        },
        {
            icon: Briefcase,
            title: "English Proficiency",
            description: "Provide IELTS/TOEFL/PTE scores meeting university requirements."
        },
        {
            icon: DollarSign,
            title: "Financial Proof",
            description: "Show sufficient funds for tuition and living expenses through bank statements or sponsorship."
        },
        {
            icon: FileText,
            title: "F-1 Visa Process",
            description: "Complete DS-160 form, pay SEVIS fee, and attend visa interview with required documents."
        }
    ];
    ...
    const faqs = [
        {
            ...
            answer: "Costs vary by university and program: Undergraduate: USD 20,000 – USD 40,000 per year, Graduate: USD 25,000 – USD 50,000 per year. Living expenses are typically USD 10,000 – USD 15,000 per year, depending on the location."
        },
        {
            question: "Can international students work while studying in the USA?",
            answer: "Yes. Students with an F-1 visa can work: On-campus: up to 20 hours/week during semesters, Full-time during holidays. For off-campus work, CPT (Curricular Practical Training) and OPT (Optional Practical Training) are available after meeting eligibility."
        },
        {
            question: "Are scholarships available for Nepali/international students?",
            answer: "Yes. Many universities offer merit-based scholarships, assistantships, and need-based aid. Top options include: Fulbright Scholarships, University-specific awards, and International student grants."
        },
        {
            question: "When should I apply to U.S. universities?",
            answer: "Start applying 10–12 months in advance of your intended intake. Fall Intake (August): Apply by November – April of the previous year, Spring Intake (January): Apply by July – October."
        },
        {
            question: "What documents are needed for a U.S. student visa?",
            answer: "Key documents include: Form I-20 (from the university), DS-160 visa application, Passport, Proof of funds, SEVIS fee receipt, Visa interview appointment confirmation, Academic records and English test scores."
        }
    ];
        ...
        <div className="bg-white pt-25">
            ...
            <div className="relative bg-gray-900">
                <div className="absolute inset-0 overflow-hidden">
                    <Image
                        src="https://images.unsplash.com/photo-1523580846011-d3a5bc7a12c3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80"
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            >
                                World-leading education with unparalleled opportunities. The U.S. offers cutting-edge research facilities and global recognition.
                            </motion.p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Experience <span className="text-[#35B354]">American Education</span></h2>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">Discover why the U.S. remains the top destination for international students</p>
                </div>

                <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden shadow-xl">
                    <iframe
                        className="w-full h-[500px]"
                        src="https://www.youtube.com/embed/5K2kL6ZSHbg"
                        title="American University Experience"
            ...
            <div id="universities" className="bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Top <span className="text-[#35B354]">Universities</span> in the USA</h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">World-renowned institutions offering exceptional education</p>
                    </div>
            ...
            <div id="requirements" className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">U.S. Study <span className="text-[#35B354]">Requirements</span></h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">Essential criteria for Nepali students planning to study in the USA</p>
                    </div>
            ...
            <div id="intakes" className="bg-[#35B354]/5 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">U.S. University <span className="text-[#35B354]">Intakes</span></h2>
            ...
            <div className="bg-[#35B354] py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-white mb-6">Ready to Begin Your American Education Journey?</h2>
