...
import { ChevronDown, BookOpen, Clock, Briefcase, DollarSign, FileText, Calendar, Check } from "lucide-react";
    ...
    const faqs = [
        {
            ...
            answer: "Tuition: NZD 20,000 – 40,000 per year (varies by course). Living expenses: NZD 20,000 per year (required proof for visa)."
        },
        {
            question: "Can I work while studying in New Zealand?",
            answer: "Yes! International students can work: Up to 20 hours per week during term time, Full-time during scheduled holidays."
        },
        {
            question: "Are scholarships available for Nepali students?",
            answer: "Yes. New Zealand offers: Government scholarships (e.g., New Zealand Scholarships for developing countries), University-specific merit-based or need-based scholarships."
        },
        {
            question: "When are the intakes in New Zealand?",
            answer: "February/March (Semester 1) – Main intake, July (Semester 2) – Mid-year intake, Some institutions offer rolling or summer intakes (Nov–Feb)."
        },
        {
            question: "What documents are needed for a student visa?",
            answer: "Key documents include: Offer of Place from a recognized institution, Proof of funds (tuition + NZD 20,000 for living), Medical & police clearance, Valid passport, Proof of English proficiency (e.g., IELTS)."
        }
    ];
        ...
        <div className="bg-white pt-25">
            ...
            <div className="relative bg-gray-900">
                <div className="absolute inset-0 overflow-hidden">
                    <Image
                        src="https://images.unsplash.com/photo-1507699622108-4be3abd695ad?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80"
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        <div>
                            ...
                            >
                                World-class education in one of the most beautiful countries. New Zealand offers innovative teaching and excellent post-study work opportunities.
                            </motion.p>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4">Experience <span className="text-[#35B354]">New Zealand Education</span></h2>
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">Discover why New Zealand is a top choice for international students</p>
                </div>

                <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden shadow-xl">
                    <iframe
                        className="w-full h-[500px]"
                        src="https://www.youtube.com/embed/6Z6zw6YF3T4"
                        title="New Zealand University Experience"
            ...
            <div id="universities" className="bg-gray-50 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">Top <span className="text-[#35B354]">Universities</span> in New Zealand</h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">NZQA-approved institutions with global recognition</p>
                    </div>
            ...
            <div id="requirements" className="py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">New Zealand Study <span className="text-[#35B354]">Requirements</span></h2>
                        <p className="text-lg text-gray-600 max-w-3xl mx-auto">Essential criteria for Nepali students planning to study in NZ</p>
                    </div>
            ...
            <div id="intakes" className="bg-[#35B354]/5 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">New Zealand University <span className="text-[#35B354]">Intakes</span></h2>
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-0">
                            ...
                            <div className="bg-[#35B354] p-4 text-white font-bold">When to Apply</div>
            ...
            <div className="bg-[#35B354] py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-white mb-6">Ready to Begin Your New Zealand Education Journey?</h2>
